...
- Добавлять игры в список 'тяжелых' `/addgame 'имя.пакета.игры'` и очищать этот список `/purgeglist`
- Очищать чат/лог `/clear chat`
- Закрывать фоновые приложения `/clear ram`
- Очищать кэш-файлы приложений `/clear cache`
- Очищать кэш шейдеров GPU `/clngpu`
