...
If device has a Qualcomm CPU [this qcom.post_boot](https://github.com/feravolt/FDE.AI-docs/blob/master/init.qcom.post_boot.sh%20LA.UM.8.6.2.r1-08600-89xx.0) script is applied in order to restore OEM kernel parameters before applying any tweaks by FDE.AI.<br>
