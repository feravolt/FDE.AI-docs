...
— Автопредзагрузка тяжелых игр/приложений в продвинутом режиме ИИ (не блокирующий режим readahead)(Необходимо приложение Preload Pro v2.1+)\
...
## **v12.4.1**
Приложение было удалено из Google Play. Подробности в официальном Телеграм канале.
### Приложение:
— Различные улучшения и оптимизация интерфейса (большое спасибо Dmitry)\
— Удален FPS метр и диалог доната\
— прочее

### База:
— Адаптивные тайминги машинного обучения\
— прочее
...
— Обновлена текстовая информация об ИИ (спасибо Dmitry)\
— Оптимизирован сервис FPS метра\
— Добавлена поддержка 12ч формата времени
...
— Исправлен конфликт extraopt auto + greenbattery\
— Подсчёт кол-ва вместо длительности срабатываний CPU/GPU турбо\
— Адаптивый темп машинного обучения\
— До-настройка различных твиков\
— прочее.
